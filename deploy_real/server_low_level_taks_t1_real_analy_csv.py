...
# hip_pitch: 150, hip_roll: 100, hip_yaw: 100, knee: 150, ankle: 40
# waist: 150, shoulder: 20, elbow: 20, wrist: 10, neck: 2.5
GLOBAL_KP = np.array([
    100, 100, 100, 150, 40, 40,  # 左腿
    100, 100, 100, 150, 40, 40,  # 右腿
    150, 150, 150,               # 腰部
    40, 40, 40, 40, 10, 10, 10,  # 左臂
    40, 40, 40, 40, 10, 10, 10,  # 右臂
    10, 10, 10,               # 脖子
], dtype=np.float32)
...
GLOBAL_KD = np.array([
    3.3, 3.3, 3.3, 5.0, 2.0, 2.0,      # 左腿
    3.3, 3.3, 3.3, 5.0, 2.0, 2.0,      # 右腿
    5.0, 5.0, 5.0,               # 腰部
    2.0, 2.0, 2.0, 2.0, 1.0, 1.0, 1.0,   # 左臂
    2.0, 2.0, 2.0, 2.0, 1.0, 1.0, 1.0,   # 右臂
    0.5, 0.5, 0.5,         # 脖子
], dtype=np.float32)
