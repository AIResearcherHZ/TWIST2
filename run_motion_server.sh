...
if [ "$robot_type" == "taks_t1" ]; then
    ...
    motion_file="../../GMR/data/HUNYUAN/20260121_104515801_e3f7cb4e_000_taks_t1.pkl"
    # motion_file="../../GMR/data/TWIST2_dataset/example_motions_taks_t1/0807_yanjie_walk_001.pkl" # 测试
